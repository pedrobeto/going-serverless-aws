...
PASSWORD=abc12354
DB_NAME=heroes
SECRET_NAME=aurora-secret02

RESOURCE_ARN=arn:aws:rds:us-east-1:111111111111:cluster:serverlesscourse
SECRET_ARN=arn:aws:secretsmanager:us-east-1:111111111111:secret:aurora-secret02-zqieQF
